...
def trip_duration_stats(df):
    ...
    trip_duration_mean_h,trip_duration_mean_h_remainder = divmod(trip_duration_mean,3600)
    trip_duration_mean_m,trip_duration_mean_s=divmod(trip_duration_mean_h_remainder,60)
